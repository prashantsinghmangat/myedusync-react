...
export const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      content: "I've taken several online courses before, but Filearn's Web Development Bootcamp stands out. The project-based approach helped me build a strong portfolio that landed me my dream job.",
      rating: 5
    },
    {
      id: 3,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Don't just take our word for it. Hear from some of our successful students who have transformed their careers with Filearn.
          </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map(testimonial => (
            <Card key={testimonial.id} className="p-6 shadow-md hover:shadow-lg transition-shadow">
